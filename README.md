...
## Other courses
We are created other Python courses tailored for Chemical Engineers, such as [Chemical Reaction Engineering in Python](https://github.com/FiammettaC/Chemical-Reaction-Engineering-in-Python) and [AI for Chemical Engineers](https://github.com/FiammettaC/AI-for-Chemical-Engineers).
